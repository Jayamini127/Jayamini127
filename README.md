...
<table>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>A role-based e-learning platform for students, teachers, and administrators, with timetable management and student performance modules built using full CRUD functionality.</p>
      <img src="https://img.shields.io/badge/MongoDB-47A248?style=flat-square&logo=mongodb&logoColor=white"/>
      <img src="https://img.shields.io/badge/Express.js-000000?style=flat-square&logo=express&logoColor=white"/>
      <img src="https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black"/>
    ...
    <td width="50%" valign="top">
      ...
      <p>An Android application for tracking daily health and wellness activities, built with a clean and accessible user interface.</p>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Designed the app's UI in Figma and developed the Android application using Kotlin, focused on a smooth and intuitive user experience.</p>
    ...
    <td width="50%" valign="top">
      ...
      <p>An online bidding platform built using core object-oriented programming concepts in Java, with bid placement functionality backed by a MySQL database.</p>
